...
<div id="content">
	<div id="main">
		<p class="topicPath"><a href="<?php bloginfo('home')?>"><?php _e('Home', 'vicuna')?></a><?php vicuna_category_relay()?> &gt; <span class="current"><?php single_cat_title()?></span></p>
		<h1><?php printf(__('%s Archive', 'vicuna'), single_cat_title()) ?></h1>
...
<?php endwhile?>
<?php vicuna_paging()?>
		<p class="topicPath"><a href="<?php bloginfo('home')?>"><?php _e('Home')?></a><?php vicuna_category_relay()?> &gt; <span class="current"><?php single_cat_title()?></span></p>
	</div><!-- end main-->
