<?php get_header()?>
<body class="dateBasedArchive <?php vicuna_page_layout()?>">
<div id="header">
...
<div id="content">
	<div id="main">
		<p class="topicPath"><a href="<?php bloginfo('home')?>"><?php _e('Home', 'vicuna')?></a> &gt; <?php _e('Archives', 'vicuna')?> &gt; <span class="current"><?php vicuna_archive_title()?></span></p>
		<h1><?php vicuna_archive_title()?></h1>
